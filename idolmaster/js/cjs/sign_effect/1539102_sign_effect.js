...
(lib.reflect_mask_1539102 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.shape.setTransform(0.0226,0,0.96,0.96);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.reflect_mask_1539102, new cjs.Rectangle(-166.8,-92.1,333.70000000000005,184.3), null);
...
(lib.reflect = function(mode,startPosition,loop) {
	...
	this.lighter_tgt.setTransform(0,-293.7,1.1811,1.1811,0,0,-20.0007);
	this.lighter_tgt.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(1));

}).prototype = getMCSymbolPrototype(lib.reflect, new cjs.Rectangle(0,-414.9,333,829.9), null);


(lib.reflect_container_cjs_1539102 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-0.5,507.15,1,1,0,0,0,-0.5,0.1);
	this.instance.compositeOperation = "lighter";
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(20).to({_off:false},0).to({regY:-0.1,y:-0.1},9,cjs.Ease.get(-1)).to({regY:0.1,y:-506.9},9,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-921.9,333,1843.9);
...
(lib.reflect_wrapper_1539102 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// cjs
	this.reflect = new lib.reflect_container_cjs_1539102();
...
}).prototype = getMCSymbolPrototype(lib.reflect_wrapper_1539102, new cjs.Rectangle(0,-414.9,333,829.9), null);
...
(lib.sign_effect_1539102 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// glitter
	this.instance = new lib.glitter_wrapper();
	this.instance.parent = this;
	this.instance.setTransform(420,466.55);

	this.instance_1 = new lib.glitter_wrapper();
	this.instance_1.parent = this;
	this.instance_1.setTransform(563.3,475.8);

	this.instance_2 = new lib.glitter_wrapper();
	this.instance_2.parent = this;
	this.instance_2.setTransform(462.05,528.85);

	this.instance_3 = new lib.glitter_wrapper();
	this.instance_3.parent = this;
	this.instance_3.setTransform(316.45,559,0.7247,0.7247);

	this.instance_4 = new lib.glitter_wrapper();
	this.instance_4.parent = this;
	this.instance_4.setTransform(575,604.25,0.6923,0.6923);

	this.instance_5 = new lib.glitter_wrapper();
	this.instance_5.parent = this;
	this.instance_5.setTransform(405.55,628.5,0.6599,0.6599);

	this.instance_6 = new lib.glitter_wrapper();
	this.instance_6.parent = this;
	this.instance_6.setTransform(385.95,522.75);

	this.instance_7 = new lib.glitter_wrapper();
	this.instance_7.parent = this;
	this.instance_7.setTransform(316.05,483.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	// mask_idn
	this.reflect_mask = new lib.reflect_mask_1539102();
	this.reflect_mask.name = "reflect_mask";
	this.reflect_mask.parent = this;
	this.reflect_mask.setTransform(433.35,549.9);
	...
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(300.1233,321.0296);

	// reflect
	this.reflect_wrapper = new lib.reflect_wrapper_1539102();
	this.reflect_wrapper.name = "reflect_wrapper";
	this.reflect_wrapper.parent = this;
	this.reflect_wrapper.setTransform(263.85,549.9,1.0195,1);
...
}).prototype = getMCSymbolPrototype(lib.sign_effect_1539102, new cjs.Rectangle(260,150.8,359.4,759), null);
...
(lib.replace = function(mode,startPosition,loop) {
	...
	// sign
	this.sign_effect = new lib.sign_effect_1539102();
...
}).prototype = getMCSymbolPrototype(lib.replace, new cjs.Rectangle(0,0,640,964.9), null);


// stage content:
(lib._1539102_sign_effect = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// replace
	this.instance = new lib.replace();
	this.instance.parent = this;
	this.instance.setTransform(309.7,482.4,1,1,0,0,0,309.7,482.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(580,535,39.39999999999998,429.9);
// library properties:
lib.properties = {
	id: '_1539102_sign_effect',
	width: 640,
	height: 800,
	fps: 18,
	color: "#333333",
...
an.compositions['_1539102_sign_effect'] = {
